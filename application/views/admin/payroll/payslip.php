              ...
              <div class="box-body">
                <div class="table-responsive" data-pattern="priority-columns">
                  <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                    <tbody>
					  <tr>
                        <td><strong>SSS Deduction:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($sss_deduction);?></span></td>
                      </tr>
					  <tr>
                        <td><strong>Philhealth Deduction:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($philhealth_deduction);?></span></td>
                      </tr>
					  <tr>
                        <td><strong>HDNF Deduction:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($hdmf_deduction);?></span></td>
                      </tr>
					  <tr>
                        <td><strong>Withholding Tax:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($tax_deduction);?></span></td>
                      </tr>
                      <tr>
              ...
              <table class="datatables-demo table table-striped table-bordered dataTable no-footer">
                <tbody>
                  ...
                  <?php
					...
					$total_deduction = $loan_de_amount + $statutory_deductions_amount + $sss_deduction + $philhealth_deduction + $tax_deduction + $hdmf_deduction;
