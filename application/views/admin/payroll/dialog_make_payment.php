...
$ishalf = $system[0]->is_half_monthly;
$sss_deduction        = $this->Employees_model->set_employee_sss_deduction($add_salary ,$ishalf);
$hdmf_deduction       = $this->Employees_model->set_employee_hdmf_deduction($add_salary,$ishalf);
$philhealth_deduction = number_format((float)$this->Employees_model->set_employee_pagibig_deduction($add_salary,$ishalf),2);
$tax_deduction        = number_format((float)$this->Employees_model->set_employee_witholding_tax($add_salary,$sss_deduction , $hdmf_deduction , $philhealth_deduction,$ishalf),2);



// add amount
$net_salary_default = ($add_salary - $loan_de_amount - $statutory_deductions_amount) - ($sss_deduction + $hdmf_deduction + $philhealth_deduction + $tax_deduction);
      ...
      <div class="col-md-4">
	   ...
	   <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" name="sss_deduction" class="form-control" value="<?php echo $sss_deduction;?>" readonly="readonly">
        </div>
      </div>
	  <div class="col-md-4">
        <div class="form-group">
          <label for="name">HDMF</label>
          <input type="text" name="hdmf_deduction" class="form-control" value="<?php echo $hdmf_deduction;?>" readonly="readonly">
        </div>
      </div>
	   <div class="col-md-4">
        <div class="form-group">
          <label for="name">Philhealth</label>
          <input type="text" name="philhealth_deduction" class="form-control" value="<?php echo $philhealth_deduction;?>" readonly="readonly">
        </div>
      </div>
	  <div class="col-md-6">
        <div class="form-group">
          <label for="name">WITHHOLDING TAX</label>
          <input type="text" name="tax_income_deduction" class="form-control" value="<?php echo $tax_deduction;?>" readonly="readonly">
        </div>
      </div>
	  <div class="col-md-6">
        <div class="form-group">
          <label for="name">DSCA</label>
          <input type="text" name="dsca_total" class="form-control" value="0" readonly="readonly">
        </div>
      </div>
    </div>
    <div class="row">
